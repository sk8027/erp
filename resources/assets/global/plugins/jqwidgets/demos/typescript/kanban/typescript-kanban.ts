    ...
    let source =
        {
            localData: [
                ...
                { state: "new", label: "Change Billing ContactAddress", tags: "billing", hex: "#f19b60", resourceId: 1 },
    ...
    let source3 =
        {
            localData: [
                ...
                { state: "work", label: "Add New ContactAddress", tags: "address", hex: "#6bbd49", resourceId: 5 },
