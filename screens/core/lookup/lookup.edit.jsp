...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="lookupValueEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,255}"  formControlName="value"  required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[a-za-zA-Z\s]{1,255}"  formControlName="description"  required="true"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <input type="hidden" formControlName="id">
             ...
             <input type="hidden" formControlName="lookupId" value="${param.lookup}" required="true">
        </form>
    </div>
</div>
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#lookupValueEditToolbar");
        toolbar.find("button").click(function () {
            if(this.id === "SaveBtn"){
                ...
                $("#lookupValueDlg").jqxWindow('close');
            }
        });
