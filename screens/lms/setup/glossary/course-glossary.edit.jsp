...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="courseGlossaryEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,255}"  formControlName="term"  required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <textarea   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,2048}"  formControlName="definition"  required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <input type="text" value="${param.session}" formControlName="sessionId">
            <input type="text" value="${param.courseSection}" formControlName="courseSectionId">
        </form>
    </div>
</div>
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#courseGlossaryEditToolbar");
        toolbar.find("button").click(function () {
            if(this.id === "SaveBtn"){
                ...
                $("#courseGlossaryDlg").jqxWindow('close');
            }
        });
