...
<div class="col-md-12" id="courseLink">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
                        ...
                        <div class="portlet light bg-inverse">
                            <div class="portlet-title">
                                <div class="caption ">
                                    ...
                                    <span class="caption-subject bold uppercase"> CourseLinkService</span>
                                    <span class="caption-helper">Filter</span>
                                </div>
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">

                                        <button type="button" id="courseLinkFilter" class="btn btn-default green"><i class="fa fa-search"></i>
                                            Search
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="table-toolbar" id="courseLinkToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>CourseLink</div>

            </div>
            <div class="portlet-body grid-container" style="height: 450px;">

                <div id="courseLinkTable"></div>
            </div>
        </div>
    </div>
    <div id="courseLinkDlg">
        <div ><span id="dlgTitle">CourseLink</span> </div>
        <div   class="dlg-content"></div>
    </div>
</div>
<script src="${pageContext.servletContext.contextPath}/screens/shared/campus-filter.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/lms/setup/links/course-links-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/lms/setup/links/course-links.js" type="text/javascript"></script>
