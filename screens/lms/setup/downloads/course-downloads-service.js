var CourseDownloadService = (function () {
    function CourseDownloadService() {
        /********************** Private Variables ******************************************/
        this.filterFields = ["sessionId","courseSectionId","resourceId"];
        this.lovMap = null;
        this.dataGrid = $("#courseDownloadTable");
        this.formDlg = $("#courseDownloadDlg");
        this.gridToolbar = $("#courseDownloadToolbar");
        this.framework = new Framework();
        this.dataForm = {};
        this.listURL = CONTEXT_PATH + '/app/course_download_controller/list';
        this.deleteURL =  CONTEXT_PATH +'/app/course_download_controller/delete';
        this.saveURL = CONTEXT_PATH + '/app/course_download_controller/save';
        this.lovURL = CONTEXT_PATH + '/app/course_download_controller/refresh_page_lov';
        this.formURL = CONTEXT_PATH + '/screens/lms/setup/downloads/course-downloads.edit.jsp';
        this.title = "Course Download";
        this.populateForm = function (data, lovMap) {
            ...
            $(this.dataForm.fileUrl).val((data.fileUrl === undefined || data.fileUrl === null )? null : data.fileUrl);
        ...
        this.fields = [
            ...
            { name: 'fileUrl', type: 'string' ,label :'Url'},
    ...
    /********************** Save Form Record ******************************************/
    CourseDownloadService.prototype.save = function () {
        this.framework.SaveForm(this);
    };
    /********************** New Record******************************************/
    CourseDownloadService.prototype.newRecord = function () {
        this.populateForm({});
    }
    /********************** Clear Form Fields For Update******************************************/
    CourseDownloadService.prototype.clear = function () {
        this.populateForm({id: $(this.dataForm.id).val()});
    };

    /********************** Finding Record by Primary key ******************************************/
    CourseDownloadService.prototype.getById = function (id) {
        ...
        $.get(this.formURL+"?courseSection="+courseSectionId,"&session="+sessionId).done(function (data) {
            ...
            CommonService.sendAjaxRequest(CONTEXT_PATH + '/app/course_download_controller/find_by_id/' + id, 'get', null, $(".form-body")).done(function (data) {
    ...
    CourseDownloadService.prototype.deleteRows = function () {
        this.framework.DeleteSelectedRows(this);
    };

    /********************** Delete Single Record showing in Popup ******************************************/
    CourseDownloadService.prototype.deleteRecord = function (id) {
        this.framework.DeleteRecord(this,id);
    };

    /********************** Load the table from Server ******************************************/
    CourseDownloadService.prototype.loadTable = function () {
        var self = this;
        $.get(this.lovURL).done(function (data) {
            ...
            if(self.filterFields != undefined ){
                ...
                $("#courseDownloadFilter").on('click',function(){
                    var courseSectionId = $("#courseSectionIdFilter").val();
                    var sessionId = $("#sessionIdFilter").val();
    ...
    CourseDownloadService.prototype.refresh = function () {
