var CourseAnnouncementService = (function () {
    function CourseAnnouncementService() {
        ...
        this.populateForm = function (data, lovMap) {
            ...
            $(this.dataForm.courseSectionName).val((data.courseSectionName === undefined || data.courseSectionName === null )? null : data.courseSectionName);
            ...
            if(self.filterFields != undefined ){
                ...
                $("#resourceIdFilter").on('open', function (event) {
                    ...
                    if(departmentId > 0) {
                        ...
                        CommonService.sendAjaxRequest(CONTEXT_PATH + "/app/CommonController/get_employees/" + departmentId, 'get', null, $("#courseAnnouncement")).then(function (data) {
                ...
                $("#courseSectionIdFilter").on('open', function (event) {
                    ...
                    if(sessionId > 0 && resourceId > 0) {
                        ...
                        CommonService.sendAjaxRequest(CONTEXT_PATH + "/app/CommonController/get_resource_courses/" + resourceId+"/"+ sessionId, 'get', null, $("#courseAnnouncement")).then(function (data) {
