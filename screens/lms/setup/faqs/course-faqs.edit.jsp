...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="courseFaqEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,512}"  formControlName="question"  required="false"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,2048}"  formControlName="answer"  required="false"/>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#courseFaqEditToolbar");
