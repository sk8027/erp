<div id="contactAddressToolbar" class="form-actions top" style="padding:5px" >
...
<div id="contactAddressTable"/>


<script src="${pageContext.servletContext.contextPath}/screens/academics/contacts/contact-address.js" type="text/javascript"></script>
