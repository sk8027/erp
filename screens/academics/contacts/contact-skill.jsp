<div id="contactSkillToolbar" class="form-actions top" style="padding:5px" >
...
<div id="contactSkillTable"/>


<script src="${pageContext.servletContext.contextPath}/screens/academics/contacts/contact-skill.js" type="text/javascript"></script>
