<div id="contactInterestToolbar" class="form-actions top" style="padding:5px" >
...
<div id="contactInterestTable"/>


<script src="${pageContext.servletContext.contextPath}/screens/academics/contacts/contact-interest.js" type="text/javascript"></script>
