...
<div class="col-md-12" id="courseSection">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
                        ...
                        <div class="portlet light bg-inverse">
                            <div class="portlet-title">
                                <div class="caption ">
                                    ...
                                    <span class="caption-subject bold uppercase"> Course Sections</span>
                                    <span class="caption-helper">Filter</span>
                                </div>
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">

                                        <button type="button" id="courseSectionFilter" class="btn btn-default green"><i class="fa fa-search"></i>
                                            Search
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="table-toolbar" id="courseSectionToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Course Sections</div>

            </div>
            <div class="portlet-body grid-container" style="height: 450px;">

                <div id="courseSectionTable"></div>
            </div>
        </div>
    </div>
    <div id="courseSectionDlg">
        <div ><span id="dlgTitle">CourseSection</span> </div>
...
<script src="${pageContext.servletContext.contextPath}/screens/academics/course-section/course-section-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/academics/course-section/course-section.js" type="text/javascript"></script>
