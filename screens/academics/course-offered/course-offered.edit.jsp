...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="courseOfferedEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <div formControlName="semesterId"  required="true"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
...
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#courseOfferedEditToolbar");
        toolbar.find("button").click(function () {
            if(this.id === "SaveBtn"){
                ...
                $("#courseOfferedDlg").jqxWindow('close');
            }
        });
