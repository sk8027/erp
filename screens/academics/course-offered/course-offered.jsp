...
<div class="col-md-12" id="courseOffered">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
                        ...
                        <div class="portlet light bg-inverse">
                            <div class="portlet-title">
                                <div class="caption ">
                                    ...
                                    <span class="caption-subject bold uppercase"> Course Offering</span>
                                    <span class="caption-helper">Filter</span>
                                </div>
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">

                                        <button type="button" id="courseOfferedFilter" class="btn btn-default green"><i class="fa fa-search"></i>
                                            Search
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="table-toolbar" id="courseOfferedToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>CourseOffered</div>

            </div>
            <div class="portlet-body grid-container" style="height: 450px;">

                <div id="courseOfferedTable"></div>
            </div>
        </div>
    </div>
    <div id="courseOfferedDlg">
        <div ><span id="dlgTitle">Course Offering</span> </div>
        <div   class="dlg-content"></div>
    </div>
</div>
<script src="${pageContext.servletContext.contextPath}/screens/shared/campus-filter.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/academics/course-offered/course-offered-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/academics/course-offered/course-offered.js" type="text/javascript"></script>
