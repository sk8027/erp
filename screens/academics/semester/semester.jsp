...
<div class="col-md-12" id="semester">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        ...
                                        <button type="button" id="semesterFilter" class="btn btn-default green"><i class="fa fa-search"></i>
                                            Search
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="table-toolbar" id="semesterToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Semester</div>
    ...
    <div id="semesterDlg">
        <div ><span id="dlgTitle">Semester</span> </div>
        <div   class="dlg-content"></div>
    </div>
</div>

<script src="${pageContext.servletContext.contextPath}/screens/shared/campus-filter.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/academics/semester/semester-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/academics/semester/semester.js" type="text/javascript"></script>
