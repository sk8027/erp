...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="semesterEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,255}"  formControlName="description"  required="false"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9]{1,2}" maxlength="2"  formControlName="semesterNo"  required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <div formControlName="academicSessionId"  required="true"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#semesterEditToolbar");
