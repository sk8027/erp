...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="studySchemeEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <div formControlName="courseId"  required="false"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <div formControlName="semesterId"  required="false"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
...
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#studySchemeEditToolbar");
        toolbar.find("button").click(function () {
            if(this.id === "SaveBtn"){
                ...
                $("#studySchemeDlg").jqxWindow('close');
            }
        });
