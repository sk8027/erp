...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" novalidate >
            <div id="academicCalendarEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <div formControlName="activityTypeId"  required="true"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="date" class="form-control"    formControlName="activityDate"  required="true"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <input type="hidden" value="${param.campus}" formControlName="campusId">
...
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#academicCalendarEditToolbar");
        toolbar.find("button").click(function () {
            if(this.id === "SaveBtn"){
                ...
                $("#academicCalendarDlg").jqxWindow('close');
            }
        });
