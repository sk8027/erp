...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <div formControlName="evaluationTypeId"  required="true"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <textarea   class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,1048}"  formControlName="description"  required="false"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9]{1,5}"  formControlName="marks"  required="false"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="date" class="form-control"    formControlName="openDate"  required="false"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="date" class="form-control"    formControlName="deadline"  required="false"/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 form-body">
            <div id="questionsToolbar" class="form-actions top" style="padding:5px" >
                <div class="btn-set pull-left">
                    <div class="btn-group">
