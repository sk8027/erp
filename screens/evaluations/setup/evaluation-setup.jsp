...
<div class="col-md-12" id="evaluationSetup">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        ...
                                        <button type="button" id="evaluationSetupFilter" class="btn btn-default green"><i class="fa fa-search"></i>
                                            Search
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="table-toolbar" id="evaluationSetupToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Evaluation Setup</div>

            </div>
            <div class="portlet-body grid-container" style="height: 450px;">

                <div id="evaluationSetupTable"></div>
            </div>
        </div>
    </div>
    <div id="evaluationSetupDlg">
        <div ><span id="dlgTitle">Evaluation Setup</span> </div>
        <div   class="dlg-content"></div>
    </div>
</div>
<script src="${pageContext.servletContext.contextPath}/screens/shared/campus-filter.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/evaluations/setup/evaluation-setup-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/evaluations/setup/evaluation-setup.js" type="text/javascript"></script>
