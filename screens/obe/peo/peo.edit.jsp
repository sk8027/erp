...
<div class="portlet box green" style="margin-top: 10px;">
    <div class="portlet-body form">
        ...
        <form class="horizontal-form" role="form" novalidate >
            <div id="programPeoEditToolbar" class="form-actions top" style="padding:5px" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,255}"  formControlName="peoName"  required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" >
                            ...
                            <div class="" >
                                <input   type="text" class="form-control"  data-inputmask-regex="^[0-9a-za-zA-Z\s]{1,2147483647}"  formControlName="peoDescription"  required="false"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="col-md-12 form-body">
                <div id="plosToolbar" class="form-actions top" style="padding:5px" >
                    <div class="btn-set pull-left">
                        <div class="btn-group">
...
<script>
    $(document).ready(function(){
        ...
        var toolbar = $("#programPeoEditToolbar");
