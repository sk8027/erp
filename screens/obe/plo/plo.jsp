...
<div class="col-md-12" id="programPlo">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
                            ...
                            <div class="portlet light bg-inverse">
                                <div class="portlet-title">
                                    <div class="caption ">
                                        ...
                                        <span class="caption-subject bold uppercase"> Program Learning Objective(PLO)</span>
                                        <span class="caption-helper">Filter</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">

                                            <button type="button" id="ploFilter" class="btn btn-default green"><i class="fa fa-search"></i>
                                                Search
                                            </button>
                                        </div>
                                    </div>
            ...
            <div class="table-toolbar" id="programPloToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Program Learning Objectives</div>

            </div>
            <div class="portlet-body grid-container" style="height: 450px;">

                <div id="programPloTable"></div>
            </div>
        </div>
    </div>
    <div id="programPloDlg">
        <div ><span id="dlgTitle">ProgramPlo</span> </div>
        <div   class="dlg-content"></div>
    </div>
</div>
</div>
<script src="${pageContext.servletContext.contextPath}/screens/shared/campus-filter.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/obe/plo/plo-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/obe/plo/plo.js" type="text/javascript"></script>
