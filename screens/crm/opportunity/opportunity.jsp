...
<div class="col-md-12" id="opportunity">
    ...
    <div class="col-md-12">
        <div class="portlet-body grid-container" >
            ...
            <div class="table-toolbar" id="opportunityToolbar">
                <div class="btn-group">
    ...
    <div class="col-md-12">
        <div class="portlet box green bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Opportunity</div>
    ...
    <div id="opportunityDisqualifyDlg">
        <div >
                    <span>
...
<script src="${pageContext.servletContext.contextPath}/screens/crm/opportunitys/contact-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/crm/opportunitys/opportunity-service.js" type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath}/screens/crm/opportunitys/opportunity.js" type="text/javascript"></script>